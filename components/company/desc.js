...
export default ()=>{
    ...
    return <section className="">
        <article>
            <h4 className="subheadings text-center fw-bold violet-color">Want to Work abroad?</h4>
            <p className="letter-spacing-desc"><h5 className="fs-5 d-inline fw-bolder">{state.Name}</h5>
            {state.companyDesc}</p>
